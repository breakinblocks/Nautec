...
public class SubmarineEntry extends BaseNautecEntry {
    public SubmarineEntry(CategoryProviderBase parent) {
        super(parent, "submarine", "Sea Scout", "A hull of your own", BookIconModel.create(NTItems.SUBMARINE));
    }
    ...
    protected void generatePages() {
        ...
        this.pageTitle("Sea Scout");
        this.pageText("""
                The trenches do not care how good your diving suit is. Past a certain depth you stop swimming and start needing a hull.
                \\
                The Sea Scout is that hull: two seats, a prismatic power cell, and enough plating to argue with whatever lives down there.
                \\
